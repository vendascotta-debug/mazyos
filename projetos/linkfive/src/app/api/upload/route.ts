...
//
// O PDF do catálogo NÃO passa por aqui: a Vercel recusa qualquer requisição
// acima de ~4,5 MB antes do código rodar, e catálogo costuma ser maior. Ele
// vai do navegador direto pro armazenamento, por `/api/upload/catalogo`.
//
